...
import io.github.nondirectional.docx.toolkit.ref.CellRef;
...
import io.github.nondirectional.docx.toolkit.result.BatchItemResult;
...
import io.github.nondirectional.docx.toolkit.result.ToolWarning;
...
public final class TableTools extends ToolkitToolContext {
  ...
  private interface CellEditResultAction {
    ToolResult<Void> apply(
        Map<String, Object> m, io.github.nondirectional.docx.core.api.table.Cell cell);
  }
  ...
  private static void appendCellStyleSummary(
      StringBuilder sb, io.github.nondirectional.docx.core.api.table.Cell cell) {
