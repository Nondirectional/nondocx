...
authoring*, *move accept/reject (paired)*, and *run-property (rPrChange) read/accept/reject* are
wrapped, while cell revisions, pPrChange, and accept/reject of those still fall back to `raw()`
until later sub-tasks land.)
