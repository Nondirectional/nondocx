 ...
 * io.github.nondirectional.docx.core.api.header.Header} / {@link
 * io.github.nondirectional.docx.core.api.header.Footer} accessors. {@link #header()} and {@link
 * #footer()} are conveniences that return the first section's default header / footer.</b>
 *
...
public final class Document implements AutoCloseable {
   ...
   */
  public io.github.nondirectional.docx.core.api.header.Header header() {
   ...
   * @throws io.github.nondirectional.docx.core.api.exception.DocxIOException 如果页眉部分无法创建或附加
   */
  public io.github.nondirectional.docx.core.api.header.Header ensureHeader() {
   ...
   * io.github.nondirectional.docx.core.api.section.Section#header(io.github.nondirectional.docx.core.api.header.HeaderFooterVariant)}。
   *
   ...
   */
  public io.github.nondirectional.docx.core.api.header.Header header(
      io.github.nondirectional.docx.core.api.header.HeaderFooterVariant variant) {
   ...
   */
  public io.github.nondirectional.docx.core.api.header.Footer footer() {
   ...
   * @throws io.github.nondirectional.docx.core.api.exception.DocxIOException 如果页脚部分无法创建或附加
   */
  public io.github.nondirectional.docx.core.api.header.Footer ensureFooter() {
   ...
   * io.github.nondirectional.docx.core.api.toc.TableOfContents} / {@link
   * io.github.nondirectional.docx.core.api.toc.TocEntry} 两个干净类型。 详见 {@link
   * io.github.nondirectional.docx.core.api.toc.TableOfContents} 的三层说明与 poi-bridge.md N11。
   *
   ...
   */
  public io.github.nondirectional.docx.core.api.toc.TableOfContents toc() {
    return io.github.nondirectional.docx.core.internal.poi.TocFields.findToc(delegate).isPresent()
        ? new io.github.nondirectional.docx.core.api.toc.TableOfContents(delegate)
        : null;
  }
   ...
   *       io.github.nondirectional.docx.core.api.track.TrackedChanges} / {@link
   *       io.github.nondirectional.docx.core.api.track.TrackedChange} 等干净类型。
   * </ul>
   *
   ...
   */
  public io.github.nondirectional.docx.core.api.track.TrackedChanges trackedChanges() {
    return new io.github.nondirectional.docx.core.api.track.TrackedChanges(delegate);
  }
   ...
   * io.github.nondirectional.docx.core.api.comment.Comments#list()}),按 OOXML {@code w:id}
   * 精确命中单条批注({@link io.github.nondirectional.docx.core.api.comment.Comments#get(String)})。
   *
   * <p><b>OOXML / POI / nondocx 三层。</b>
   *
   * <ul>
   ...
   *       internal/poi/CommentNodes},对外只暴露 {@link
   *       io.github.nondirectional.docx.core.api.comment.Comments} / {@link
   *       io.github.nondirectional.docx.core.api.comment.Comment} 等 POI-free 类型。
   * </ul>
   *
   * <p><b>与 {@code toc()} 的区别。</b> {@code toc()} 在文档无 TOC 时返回 {@code null};而批注的「列表」总是有
   * 意义的(即便为空),故本方法<b>总是返回非 null</b>门面对象。文档无批注时 {@link
   * io.github.nondirectional.docx.core.api.comment.Comments#list()} 返回空列表,不抛异常。
   *
   * <p><b>只读。</b> 创作批注、回复、resolve 状态均不属于当前 read 子任务。
   *
   * @return 批注能力门面(从不为 {@code null})
   */
  public io.github.nondirectional.docx.core.api.comment.Comments comments() {
    return new io.github.nondirectional.docx.core.api.comment.Comments(delegate);
  }
