...
import io.github.nondirectional.docx.core.api.section.Orientation;
 ...
 * io.github.nondirectional.docx.core.api.style} / {@code
 * io.github.nondirectional.docx.core.api.image} 中的公有值对象在源代码层面（而不仅仅是签名层面） 保持无 POI 依赖。
 */
