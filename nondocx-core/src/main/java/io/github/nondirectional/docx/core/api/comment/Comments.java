...
import io.github.nondirectional.docx.core.internal.poi.CommentNodes;
 ...
 *
 * <p>由 {@link io.github.nondirectional.docx.core.api.Document#comments()} 返回。本门面负责两件只读事:
 *
 * <ul>
...
public final class Comments {
   ...
   * 封装给定的 POI 文档以解析其批注。
   *
   * <p>此构造函数是 {@link io.github.nondirectional.docx.core.api.Document} 生成批注视图的<b>内部接缝</b>,因此它有意接受
   * POI 类型(与 {@code TrackedChanges(XWPFDocument)} 接受 {@code XWPFDocument} 的方式一致,见 poi-bridge.md
   * N1)。 用户通过 {@code Document.comments()} 获取,而不是直接构造。
   *
