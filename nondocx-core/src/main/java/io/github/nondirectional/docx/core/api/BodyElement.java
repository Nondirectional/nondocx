 ...
 *
 * <p>实现包括 {@code io.github.nondirectional.docx.core.api.text.Paragraph} 和 {@code
 * io.github.nondirectional.docx.core.api.table.Table}，将在后续阶段添加。这目前是一个标记接口； 随着领域模型的增长，公共成员可能会被提升到其中。
 */
