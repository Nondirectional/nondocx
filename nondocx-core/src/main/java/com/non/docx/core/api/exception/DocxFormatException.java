 ...
 *
 * <p>The offending source path, when available, is carried as context and exposed via
 * {@link #getPath()} so callers can pinpoint which file is corrupt or malformed.
 *
...
public class DocxFormatException extends DocxException {
    ...
    /**
     * Returns the source path of the malformed document, or {@code null} when the source was a
     * stream or the path is otherwise unknown.
     *
