...
/**
 * A cell within a {@link Row} — a container of paragraphs, the smallest addressable unit of a table.
 *
 ...
 *
 * <p>A cell is <em>not</em> a body element — it lives inside a row, inside a table. Its content is an
 * ordered sequence of paragraphs, returned by {@link #paragraphs()}. Content equality
 ...
 * clearing that paragraph's existing runs) and returns {@code this} for chaining; this mirrors POI's
 * {@code XWPFTableCell.setText}. Paragraphs beyond the first are left in place.
 *
...
public final class Cell {
     ...
     * it accepts a POI type by design. Users normally obtain cells via {@code Row.cells()} /
     * {@code Row.addCell()} rather than constructing them directly.
     *
