...
public final class ShadingNodes {
  ...
  private static Shading readShd(CTShd shd) {
    ...
    com.non.docx.core.api.style.ShadingPattern pattern = Mappers.fromPoi(shd.getVal());
    ...
    com.non.docx.core.api.style.ShadingPattern safePattern =
        pattern != null ? pattern : com.non.docx.core.api.style.ShadingPattern.CLEAR;
