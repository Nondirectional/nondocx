package com.non.docx.core.api.toc;

import com.non.docx.core.internal.poi.TocFields;
...
public final class TableOfContents {
   ...
   *
   * <p>此构造函数是 {@link com.non.docx.core.api.Document} 生成 TOC 视图的内部接缝,因此它有意接受 POI 类型 (与其他包装器接受其底层
   * {@code XWPF*} 的方式一致,见 poi-bridge.md N1)。用户通过 {@code Document.toc()} 获取 TOC,而不是直接构造。
   *
   ...
   * {@link com.non.docx.core.api.Document#toc()} 的 {@code null} 判定「根本没有 TOC」,本方法仅在确认存在 TOC 后被调用。
   *
