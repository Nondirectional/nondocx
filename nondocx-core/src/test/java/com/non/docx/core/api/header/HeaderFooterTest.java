 ...
 * mid-body section break, and the design treats section-scoped header/footer primarily via
 * {@code Section.header()} / {@code Section.footer()} on each {@code Section} rather than via a
 * global. Single-section header / footer is exercised thoroughly below.
 */
