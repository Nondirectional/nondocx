...
/**
 * Verifies that {@code Paragraph.list(ListKind, int)} / {@code clearList()} round-trip through
 * save → open, that nesting levels survive, and that list membership participates in content
 * equality.
 */
